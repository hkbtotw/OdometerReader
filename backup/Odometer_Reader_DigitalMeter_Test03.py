...
image_path="C:/Users/70032204/Pictures/Analog/Digital/"
...
for n in files:
    ...
    # If there is License plate tag in image, paint it gray and re-detect the digit bar location with the regulat Meter Detection (not new model with Digital meter tag)
    # Try two times, assumed no more than 2 white stickers on dashboard
    ...
    #------------------------------------------------------------------------------
    # Option1  : Read cropped image with Read API
    # Use Read API to read from the cropped image 
    DigitNumber2 = ''
    ExtractNumber =''
    RealProp = ''
    TrueFalse = ''
...
file_path =r'D:\Python\Odometer_DigitalMeter_Test_2_Multiple - Detect Digit and read api - Decision\Odometer_DigitalMeter_Test_2\Output\Output.csv'
